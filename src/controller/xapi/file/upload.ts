...
export class UploadController extends Controller {
  @HttpMethod({
    ...
    middleware: ['auth.userRequired', 'auth.appMemberRequired', 'params.check'],
    args: {
      'params.check': [['fileType']]
    },
  })
  async fromConsole() {
  ...
  @HttpMethod({
    path: '/upload_from_xtransit',
    method: HttpMethods.POST,
    middleware: ['params.check'],
    args: {
      'params.check': [['fileId', 'fileType', 'nonce', 'timestamp', 'signature']]
    },
  })
  async fromXtransit() {
